...
def validate_branch_and_pr_title(branch, pr_title):
    ...
    print(f"Validation successful: The branch '{branch}' and the PR title '{pr_title}' follow the 'TACS-' pattern.")
